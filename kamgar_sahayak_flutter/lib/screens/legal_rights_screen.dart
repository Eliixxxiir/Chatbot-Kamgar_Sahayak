...
final Map<String, String> documentLinks = const {
            ...
            Expanded(
              child: ListView(
                children: documentLinks.entries
                    .map((entry) => _buildDocumentRow(context, entry.key, entry.value))
                    .toList(),
              ),
            ),
          ],
  ...
  Widget _buildDocumentRow(BuildContext context, String documentName, String url) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          IconButton(icon: const Icon(Icons.download, color: Colors.orange), onPressed: () => _launchURL(url)),
          IconButton(icon: const Icon(Icons.visibility, color: Colors.orange), onPressed: () => _launchURL(url)),
        ],
      ),
    );
  }
